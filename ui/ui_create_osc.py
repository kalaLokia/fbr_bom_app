...
class Ui_DialogUpdateFromFile(object):
    ...
    def retranslateUi(self, DialogUpdateFromFile):
        ...
        DialogUpdateFromFile.setWindowTitle(_translate("DialogUpdateFromFile", "Update OS Charges"))
        ...
        self.label_info.setText(_translate("DialogUpdateFromFile", "Column names: article, stitching, printing  (article format: 0000-BK-G)"))
